...
import ViewUserGroups from './pages/Admin/ViewUserGroups';
...
function App() {
  return (
    <Routes>
      ...
      <Route path='/admin/user_groups' element={<ViewUserGroups/>} />
      ...
      <Route path='/approver/ViewAdminForms' element={<Approver />} />
